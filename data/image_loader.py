...
from .data_transform import MultiViewDataInjector, get_transform, SSLMaskDataset
...
class ImageLoader():
    ...
    def get_dataset(self, stage):
        ...
        mask_file = os.path.join(self.image_dir, stage + '_tf_img_to_' + self.mask_type + '.pkl')

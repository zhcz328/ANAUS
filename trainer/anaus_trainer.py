...
class ANAUSTrainer:
    def __init__(self, config):
        ...
        if self.enable_wandb:
            ...
            if self.gpu==0 or self.log_all:
                wandb.init(project="ANAUS",name = save_dir+'_gpu_'+str(self.rank))
    ...
    def construct_model(self):
        ...
        assert self.stage == 'train', ValueError(f'Invalid stage: {self.stage}, only "train" for ANAUS training')

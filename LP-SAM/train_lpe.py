...
from SAM.utils.generate_prompts import get_click_prompt
...
def main():
    ...
    parser.add_argument("--load_auto_prompter", default=False, action='store_true')
    ...
    model = sam_model_registry[args.vit_name](args=args, checkpoint=args.sam_ckpt)
